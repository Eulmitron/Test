...
public class SierraTroutQuest extends JPanel implements ActionListener, KeyListener {
    ...
    public SierraTroutQuest() {
        ...
        levels = new Level[] {
            new Level("River Bend", "Sun", "None", fishMap("Rainbow Trout",0.5,"Brown Trout",0.3,"Brook Trout",0.2)),
            new Level("Mountain Stream", "Snow", "Cold", fishMap("Rainbow Trout",0.4,"Brown Trout",0.3,"Golden Trout",0.3)),
            new Level("High Lake", "Thunder", "Storm", fishMap("Cutthroat Trout",0.5,"Rainbow Trout",0.3,"Brown Trout",0.2)),
            new Level("Foothill Pond", "Rain", "Muddy", fishMap("Brown Trout",0.5,"Rainbow Trout",0.4,"Brook Trout",0.1)),
            new Level("Alpine Lake", "Sun", "Wind", fishMap("Golden Trout",0.5,"Cutthroat Trout",0.3,"Rainbow Trout",0.2))
        };
